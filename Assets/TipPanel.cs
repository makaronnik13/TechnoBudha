...
public class TipPanel : MonoBehaviour
{
    ...
    private bool ShowingContent 
    {
        get
        {
            return !poseTracker.Tracking;
        }
        set
        {
            poseTracker.Tracking = !value;
        }
    }
    ...
    void Start()
    {
        poseTracker.bodyTracked.Subscribe(v=>
        {
            if (!ShowingContent)
            {
                TrackingStateChanged(v);
            }
        }).AddTo(this);


        poseTracker.poseTracked.Subscribe(v=>
        {
            if (!ShowingContent)
            {
                PoseStateChanged(v);
    ...
    public void Show()
    {
        //Debug.Log("show "+ShowTipCoroutine+"/"+ShowingContent);
